...
marginalLikelihood_studentt <- importanceSampling(
                                  input_model = 'Student-t',
                                  input_lowerBound = 4.1,
                                  input_upperBound = 50)
marginalLikelihood_GED <- importanceSampling(
                                  input_model = 'GED',
...
b_result <- compute_modelProbabilities(marginalLikelihood_studentt, marginalLikelihood_GED)

print(paste('marginalLikelihood_studentt:',marginalLikelihood_studentt))
print(paste('marginalLikelihood_GED:',marginalLikelihood_GED))
...
c_result <- compute_modelProbabilities(marginalLikelihood_studentt, marginalLikelihood_GED)
