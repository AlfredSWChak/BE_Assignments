...
stats_b <- summary_stats(mu_posterior_b)
stats_c <- summary_stats(mu_posterior_c)

results_table <- rbind(a = stats_a, b = stats_b, c = stats_c)
print(round(results_table, 4))

cat("\nFrequentist t-test: t =", round(t_stat,4), " p =", round(p_value,4), "\n")
```
```
